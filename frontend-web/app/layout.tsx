...
var st=raw?(JSON.parse(raw).state||{}):{};var theme=st.theme||'claude';var accent=st.accent||'clay';
var T={
claude:['#F5F4EE','#EFEDE4','#FBFAF7','#FBFAF7','#EDEBE2','#E4E1D6','rgba(245,244,238,0.85)','rgba(120,90,60,0.14)','rgba(60,52,40,0.10)','rgba(60,52,40,0.16)','#2B2A27','#6B655C','#9C968B',0],
...
var A={clay:['#C96442','#DA8A6A','rgba(201,100,66,0.22)'],blue:['#2563EB','#60A5FA','rgba(37,99,235,0.22)'],purple:['#7C3AED','#A78BFA','rgba(124,58,237,0.22)'],green:['#10B981','#34D399','rgba(16,185,129,0.22)'],red:['#EF4444','#F97316','rgba(239,68,68,0.22)'],orange:['#F97316','#EAB308','rgba(249,115,22,0.22)'],pink:['#EC4899','#F43F5E','rgba(236,72,153,0.22)']};
var t=T[theme]||T.claude,a=A[accent]||A.clay,s=document.documentElement.style,P=function(k,v){s.setProperty(k,v)};
